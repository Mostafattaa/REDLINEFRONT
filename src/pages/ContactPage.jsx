    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-primary-50/20 to-purple-50/20">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="grid md:grid-cols-2 gap-12">
          {/* Contact Information */}
          <div>
            <h2 className="text-4xl font-bold mb-8 bg-gradient-to-r from-primary-600 to-purple-600 bg-clip-text text-transparent">
              Contact Information
            </h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 p-6 bg-white rounded-2xl shadow-md border border-gray-100">
                <div className="w-12 h-12 bg-gradient-to-br from-primary-600 to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-gray-600">support@redline.com</p>
                  <p className="text-gray-600">sales@redline.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 bg-white rounded-2xl shadow-md border border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+20 (155) 236-3502</p>
                  <p className="text-gray-600">Sat-Thu 9am-6pm EST</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 bg-white rounded-2xl shadow-md border border-gray-100">
                ...
                <div>
                  <h3 className="font-bold text-lg text-gray-900 mb-1">Office</h3>
                  <p className="text-gray-600">6th October City</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-12 h-12 bg-white border-2 border-gray-200 rounded-xl flex items-center justify-center hover:border-primary-500 hover:bg-primary-50 transition-all">
