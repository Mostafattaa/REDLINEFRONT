      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center gap-2 px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-primary-300 hover:bg-primary-50 transition-all font-medium text-gray-700">
